...
// Code taken from http://https://github.com/microsoft/grover-blocks and refactored for QDK 0.18.2106148911
...
namespace QTests.AES
{
    ...
    operation ByteSub(_input_state: Result[], costing: Bool) : Result[][]
    {
        ...
        use (input_state_1, input_state_2, input_state_3, input_state_4, output_state_1, output_state_2, output_state_3, output_state_4) = (Qubit[32], Qubit[32], Qubit[32], Qubit[32], Qubit[32], Qubit[32], Qubit[32], Qubit[32])
            {
    ...
    operation AddRoundKey(_state: Result[], _round_key: Result[]) : Result[][]
    {
        ...
        use (state_1, state_2, state_3, state_4,round_key) = (
                    Qubit[32], Qubit[32], Qubit[32], Qubit[32],Qubit[4*32])
        {
            let state = [state_1, state_2, state_3, state_4];
            for j in 0..3
            {
    ...
    operation Round(_state: Result[], _round_key: Result[], round: Int, smart_wide: Bool, Nk: Int, in_place_mixcolumn: Bool, costing: Bool) : Result[][]
    {
        ...
        use (       in_state_1, in_state_2, in_state_3, in_state_4,
